...
<div class="search-bar">
	...
	<nav>
		...
		<a href="home.html">	<button >Nha Trang</button></a>
		<a href="Namhoi.jsp"><button>Nam Hội An</button></a>
		<a href="HaLong.jsp">  <button>Hạ Long</button></a>
	</nav>
	<main>
		<section class="hotel">
			<img src="static/images/HL.jpg" alt="Vinpearl Resort & Spa Hạ Long">
			<div class="info">
				<h2>Vinpearl Resort & Spa Hạ Long</h2>
				<p>Đảo Rều, Bãi Cháy, Thành phố Hạ Long, Tỉnh Quảng Ninh</p>
				<p>
